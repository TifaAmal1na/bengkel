        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto">
                        <i class="fas fa-tasks fa-2x text-gray-300"></i> <!-- Ikon alternatif -->
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="chart-container" style="border: 3px solid; border-radius: 10px; box-shadow: 0 4px 8px rgba(100, 143, 236, 0.2); padding: 0;">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="chart-container" style="border: 3px solid; border-radius: 10px; box-shadow: 0 4px 8px rgba(100, 143, 236, 0.2); padding: 0; height: 400px; width: 100%;">
